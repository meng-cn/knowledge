import{_ as i,o as a,c as n,a0 as l}from"./chunks/framework.D7EjqxMK.js";const g=JSON.parse('{"title":"01 - Runtime 深度","description":"","frontmatter":{},"headers":[],"relativePath":"01-ios/10_System_Principles/01_Runtime_Deep.md","filePath":"01-ios/10_System_Principles/01_Runtime_Deep.md"}'),p={name:"01-ios/10_System_Principles/01_Runtime_Deep.md"};function h(t,s,k,e,r,d){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h1 id="_01-runtime-深度" tabindex="-1">01 - Runtime 深度 <a class="header-anchor" href="#_01-runtime-深度" aria-label="Permalink to &quot;01 - Runtime 深度&quot;">​</a></h1><h2 id="目录" tabindex="-1">目录 <a class="header-anchor" href="#目录" aria-label="Permalink to &quot;目录&quot;">​</a></h2><ol><li><a href="#1-objc-runtime-架构">ObjC Runtime 架构</a></li><li><a href="#2-消息发送机制">消息发送机制</a></li><li><a href="#3-动态绑定与转发">动态绑定与转发</a></li><li><a href="#4-method-swizzling-全栈">Method Swizzling 全栈</a></li><li><a href="#5-分类category与扩展extension原理">分类（Category）与扩展（Extension）原理</a></li><li><a href="#6-关联对象associated-objects">关联对象（Associated Objects）</a></li><li><a href="#7-protocol-witness-table">Protocol Witness Table</a></li><li><a href="#8-swift-runtime">Swift Runtime</a></li><li><a href="#9-面试题汇总">面试题汇总</a></li></ol><hr><h2 id="_1-objc-runtime-架构" tabindex="-1">1. ObjC Runtime 架构 <a class="header-anchor" href="#_1-objc-runtime-架构" aria-label="Permalink to &quot;1. ObjC Runtime 架构&quot;">​</a></h2><h3 id="_1-1-runtime-系统概览" tabindex="-1">1.1 Runtime 系统概览 <a class="header-anchor" href="#_1-1-runtime-系统概览" aria-label="Permalink to &quot;1.1 Runtime 系统概览&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>ObjC Runtime 系统架构（源码级）：</span></span>
