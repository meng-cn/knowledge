import{_ as a,o as i,c as n,a0 as p}from"./chunks/framework.D7EjqxMK.js";const g=JSON.parse('{"title":"Android 包安装流程深度解析","description":"","frontmatter":{},"headers":[],"relativePath":"00-android/14_System/07_包安装流程.md","filePath":"00-android/14_System/07_包安装流程.md"}'),l={name:"00-android/14_System/07_包安装流程.md"};function h(k,s,e,t,r,E){return i(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="android-包安装流程深度解析" tabindex="-1">Android 包安装流程深度解析 <a class="header-anchor" href="#android-包安装流程深度解析" aria-label="Permalink to &quot;Android 包安装流程深度解析&quot;">​</a></h1><h2 id="目录" tabindex="-1">目录 <a class="header-anchor" href="#目录" aria-label="Permalink to &quot;目录&quot;">​</a></h2><ol><li><a href="#1-包安装概述">包安装概述</a></li><li><a href="#2-安装方式详解">安装方式详解</a></li><li><a href="#3-packageinstallerservice">PackageInstallerService</a></li><li>[PMS 解析 APK](#4-pms 解析 apk)</li><li><a href="#5-签名验证机制">签名验证机制</a></li><li><a href="#6-权限授予流程">权限授予流程</a></li><li>[dex2oat 优化](#7-dex2oat 优化)</li><li><a href="#8-安装失败原因">安装失败原因</a></li><li><a href="#9-增量更新">增量更新</a></li><li><a href="#10-面试考点">面试考点</a></li></ol><hr><h2 id="_1-包安装概述" tabindex="-1">1. 包安装概述 <a class="header-anchor" href="#_1-包安装概述" aria-label="Permalink to &quot;1. 包安装概述&quot;">​</a></h2><h3 id="_1-1-apk-包结构" tabindex="-1">1.1 APK 包结构 <a class="header-anchor" href="#_1-1-apk-包结构" aria-label="Permalink to &quot;1.1 APK 包结构&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>APK 文件结构详解：</span></span>
