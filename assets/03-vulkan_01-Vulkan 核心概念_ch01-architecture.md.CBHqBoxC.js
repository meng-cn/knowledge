import{_ as n,o as a,c as p,ae as e}from"./chunks/framework.Czhw_PXq.js";const u=JSON.parse('{"title":"第一章 · Vulkan 架构与核心概念","description":"","frontmatter":{},"headers":[],"relativePath":"03-vulkan/01-Vulkan 核心概念/ch01-architecture.md","filePath":"03-vulkan/01-Vulkan 核心概念/ch01-architecture.md"}'),l={name:"03-vulkan/01-Vulkan 核心概念/ch01-architecture.md"};function i(t,s,c,r,d,o){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="第一章-·-vulkan-架构与核心概念" tabindex="-1">第一章 · Vulkan 架构与核心概念 <a class="header-anchor" href="#第一章-·-vulkan-架构与核心概念" aria-label="Permalink to &quot;第一章 · Vulkan 架构与核心概念&quot;">​</a></h1><h2 id="_1-1-vulkan-是什么" tabindex="-1">1.1 Vulkan 是什么 <a class="header-anchor" href="#_1-1-vulkan-是什么" aria-label="Permalink to &quot;1.1 Vulkan 是什么&quot;">​</a></h2><p><strong>Vulkan</strong>（Khronos Group 于 2016 年发布）是一个<strong>低级、跨平台的图形 API</strong>，专为高性能 3D 图形和计算设计。</p><h3 id="核心设计哲学" tabindex="-1">核心设计哲学 <a class="header-anchor" href="#核心设计哲学" aria-label="Permalink to &quot;核心设计哲学&quot;">​</a></h3><table tabindex="0"><thead><tr><th>原则</th><th>说明</th></tr></thead><tbody><tr><td><strong>显式控制</strong></td><td>一切由开发者管理，Driver 几乎不干预</td></tr><tr><td><strong>低开销</strong></td><td>减少 CPU 驱动层开销，CPU/GPU 并行</td></tr><tr><td><strong>多线程优化</strong></td><td>原生支持多线程命令提交</td></tr><tr><td><strong>精确同步</strong></td><td>开发者完全控制资源访问时序</td></tr><tr><td><strong>硬件抽象层</strong></td><td>面向现代 GPU 架构直接映射</td></tr></tbody></table><h3 id="为什么选择-vulkan" tabindex="-1">为什么选择 Vulkan？ <a class="header-anchor" href="#为什么选择-vulkan" aria-label="Permalink to &quot;为什么选择 Vulkan？&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>OpenGL:                    Vulkan:</span></span>
...
<span class="line"><span>           └── Window/System</span></span></code></pre></div><h2 id="_1-6-关键术语速查" tabindex="-1">1.6 关键术语速查 <a class="header-anchor" href="#_1-6-关键术语速查" aria-label="Permalink to &quot;1.6 关键术语速查&quot;">​</a></h2><table tabindex="0"><thead><tr><th>术语</th><th>说明</th><th>类比</th></tr></thead><tbody><tr><td><strong>Instance</strong></td><td>Vulkan 实例，与驱动的连接</td><td>HTTP 客户端</td></tr><tr><td><strong>Physical Device</strong></td><td>实际的 GPU 硬件</td><td>物理显卡</td></tr><tr><td><strong>Logical Device</strong></td><td>从 Physical Device 创建的虚拟连接</td><td>数据库连接</td></tr><tr><td><strong>Queue</strong></td><td>GPU 执行命令的队列</td><td>打印机队列</td></tr><tr><td><strong>Command Buffer</strong></td><td>记录命令的缓冲</td><td>录制视频</td></tr><tr><td><strong>Render Pass</strong></td><td>定义渲染结构</td><td>烹饪步骤</td></tr><tr><td><strong>Pipeline</strong></td><td>渲染状态</td><td>烹饪配方</td></tr><tr><td><strong>Buffer</strong></td><td>线性内存（顶点、Uniform）</td><td>数组</td></tr><tr><td><strong>Image</strong></td><td>纹理资源</td><td>图像文件</td></tr><tr><td><strong>Sampler</strong></td><td>纹理采样配置</td><td>放大镜设置</td></tr><tr><td><strong>Frame Buffer</strong></td><td>帧缓冲（附件绑定）</td><td>画布</td></tr><tr><td><strong>Swap Chain</strong></td><td>帧缓冲管理</td><td>电影胶片</td></tr><tr><td><strong>Fence</strong></td><td>驱动完成信号（CPU/GPU 同步）</td><td>锁</td></tr><tr><td><strong>Semaphore</strong></td><td>GPU/GPU 同步</td><td>信号灯</td></tr><tr><td><strong>Memory</strong></td><td>GPU 显存管理</td><td>malloc</td></tr><tr><td><strong>Descriptor Set</strong></td><td>描述符绑定（UBO、SRV）</td><td>变量绑定</td></tr></tbody></table><h2 id="_1-7-vulkan-vs-opengl-核心差异" tabindex="-1">1.7 Vulkan vs OpenGL 核心差异 <a class="header-anchor" href="#_1-7-vulkan-vs-opengl-核心差异" aria-label="Permalink to &quot;1.7 Vulkan vs OpenGL 核心差异&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>OpenGL (Fixed Function):         Vulkan (Explicit):</span></span>
<span class="line"><span>─────────────────────            ────────────────────</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    swap_chain.present_image(image_index)</span></span></code></pre></div><h2 id="_1-9-核心-api-分类速查" tabindex="-1">1.9 核心 API 分类速查 <a class="header-anchor" href="#_1-9-核心-api-分类速查" aria-label="Permalink to &quot;1.9 核心 API 分类速查&quot;">​</a></h2><table tabindex="0"><thead><tr><th>类别</th><th>函数</th></tr></thead><tbody><tr><td><strong>初始化</strong></td><td><code>vkCreateInstance()</code>, <code>vkCreateDevice()</code></td></tr><tr><td><strong>枚举</strong></td><td><code>vkEnumeratePhysicalDevices()</code>, <code>vkEnumerateInstanceExtensionProperties()</code></td></tr><tr><td><strong>资源</strong></td><td><code>vkCreateBuffer()</code>, <code>vkCreateImage()</code>, <code>vkCreateSampler()</code></td></tr><tr><td><strong>内存</strong></td><td><code>vkAllocateMemory()</code>, <code>vkBindBufferMemory()</code></td></tr><tr><td><strong>命令</strong></td><td><code>vkAllocateCommandBuffers()</code>, <code>vkCmdDraw()</code>, <code>vkQueueSubmit()</code></td></tr><tr><td><strong>同步</strong></td><td><code>vkCreateFence()</code>, <code>vkCreateSemaphore()</code>, <code>vkWaitForFences()</code></td></tr><tr><td><strong>渲染</strong></td><td><code>vkCreateRenderPass()</code>, <code>vkCreateFramebuffer()</code></td></tr><tr><td><strong>管线</strong></td><td><code>vkCreateGraphicsPipelines()</code></td></tr><tr><td><strong>呈现</strong></td><td><code>vkAcquireNextImageKHR()</code>, <code>vkQueuePresentKHR()</code></td></tr><tr><td><strong>交换链</strong></td><td><code>vkCreateSwapchainKHR()</code>, <code>vkDestroySwapchainKHR()</code></td></tr></tbody></table><hr>`,43)])])}const k=n(l,[["render",i]]);export{u as __pageData,k as default};
